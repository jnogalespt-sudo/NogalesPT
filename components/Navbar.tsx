      ...
      <nav className="bg-white border-b border-slate-200 sticky top-0 z-[50] h-16 flex items-center">
        <div className="max-w-7xl mx-auto px-4 w-full flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <button onClick={() => navigateTo(AppView.Dev)} className="text-xs font-black uppercase text-slate-500 hover:text-indigo-600 transition-colors">Dev</button>
        ...
        <div className="fixed inset-0 z-[100] md:hidden">
          ...
          <div className="absolute right-0 top-0 bottom-0 w-80 bg-white shadow-2xl flex flex-col animate-in slide-in-from-right duration-300">
            ...
            <div className="flex-1 p-6 space-y-6">
              ...
              <button onClick={() => navigateTo(AppView.Dev)} className="flex items-center gap-4 w-full text-left font-black uppercase text-slate-600 hover:text-indigo-600"><LayoutGrid size={20} /> Dev</button>
